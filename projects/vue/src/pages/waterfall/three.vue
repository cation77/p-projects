...
import FsBookVirtualWaterfall2 from '../../components/waterfall/FsBookVirtualWaterfall2.vue'
import { ICardItem } from '../../components/waterfall/type'
import list from '../../mock/waterfall'
